...
{
    class MutantCopySettingsTool : DragTool
    {
        public static MutantCopySettingsTool instance;
        ...
        public override void OnPrefabInit()
        {
            ...
            var areaVisualizer = Util.KInstantiate(avTemplate, gameObject, nameof(MutantCopySettingsTool) + "AreaVisualizer");
